    ...
    <>
      {isOpen && (
        <div className="backdrop-blur-[2px] fixed z-50 top-0 left-0 bg-black/50 w-[100vw] h-[100vh]">
          <div className="flex flex-col justify-center items-center absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] min-w-[300px] min-h-[200px] bg-white rounded-[1rem]">
            <Button
              onClick={closeModal}
