...
function Modal({ id, children, className }) {
  ...
  return (
    <div className={`backdrop-blur-[2px] fixed z-50 top-0 left-0 bg-black/50 w-[100vw] h-[100vh]`}>
      <div
        className={`${className} p-[1rem] flex flex-col justify-center items-center absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] xl:min-w-[600px] min-w-[90vw] min-h-[200px] bg-white rounded-[1rem]`}
      >
        <Button
          onClick={closeModal}
