...
function GearContainer({ gear }) {
  return (
    <div className="flex p-[2rem] justify-between border-b-2 border-primary-100">
      ...
      <p className="pt-[1rem] text-primary-700 italic text-right">{gear.description ? `„${gear.description}”` : `A place for short description` }</p>
    </div>
  );
}
