...
function OriginCont({ coffee }) {
  ...
  return (
    <DetailsPrimary className="xl:mt-5 self-end xl:rounded-l-[1rem] xl:rounded-r-full bg-gradient-1 relative overflow-visible xl:min-h-[300px]">
      ...
      <div className="flex flex-col xl:justify-center xl:items-center xl:w-[60%] w-[80%] !m-auto xl:!m-0 !mt-4 xl:!mt-0 xl:pr-10">
        ...
        <P className="xl:w-[100%] w-full self-center xl:pr-[2rem] p-[1rem] xl:p-0 xl:text-[1.2rem] text-center">{`„${description}”`}</P>
      </div>
    </DetailsPrimary>
  );
}
