    ...
    <div className="w-[100%] ">
      ...
      <H2>Flavours</H2>
          <div className="flex gap-2 w-full justify-center h-auto flex-wrap ">
            {coffee.taste.map((t) => (
              <div key={t.name + "container"} className="relative w-[160px] h-[70px]">
                <Tag key={t.name + "tag"} color={t.category} text={t.name} addClass="absolute bottom-0 left-[50%] bottom-[10px] translate-x-[-50%] w-[160px]"/>
                <Image
                  alt={t.name + "image"}
